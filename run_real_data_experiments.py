...
class ICEWSDownloader:
    ...
    # ICEWS14 from standard benchmarks
    URLS = {
        "train": "https://raw.githubusercontent.com/INK-USC/RE-Net/master/data/ICEWS14/train.txt",
        "valid": "https://raw.githubusercontent.com/INK-USC/RE-Net/master/data/ICEWS14/valid.txt",
        "test": "https://raw.githubusercontent.com/INK-USC/RE-Net/master/data/ICEWS14/test.txt",
    }
    ...
    def download(self) -> bool:
        ...
        print(f"  ICEWS14 download complete")
        return True
        ...
        for root, dirs, files in os.walk(custodian_dir):
            for fname in files:
                ...
                try:
                    ...
                    # Track for threading
                    if message_id:
                        message_id_to_record[message_id] = record_id
                    if in_reply_to:
                        in_reply_to_map[in_reply_to].append(record_id)
